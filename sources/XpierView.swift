...
private class XpierLayoutDelegate: NSObject, NSTextLayoutManagerDelegate {
...
final class XpierView: NSView {
  let textView: NSTextView

  private let squirrelLayoutDelegate: XpierLayoutDelegate
  ...
  var lightTheme = XpierTheme()
  var darkTheme = XpierTheme()
  var currentTheme: XpierTheme {
  ...
  override init(frame frameRect: NSRect) {
    squirrelLayoutDelegate = XpierLayoutDelegate()
...
private extension XpierView {
  ...
  func pagingLayer(theme: XpierTheme, preeditRect: CGRect) -> (CAShapeLayer, CGPath?, CGPath?) {
    let layer = CAShapeLayer()
